class Form{
    constructor(){
        ...
        //question 2
        this.question2 = createElement('h4', "Q2. SHOULD WE START A CLUB FOR INNOVATION AND WILL YOU CONTRIBUTE?");
        ...
        this.description= createInput("If you have any queries type here!!!");
    ...
    display(){
        ...
        this.title.position(displayWidth/4 + 50 ,20);
        this.name.html("Your Name");
        this.name.position(displayWidth/4 + 50 ,125);
        this.input.position(displayWidth/4 + 300 , 155);
        this.emailinput.html("Your Email");
        this.emailinput.position(displayWidth/4 + 50 ,200);
        this.email.position(displayWidth/4 + 300 ,225);
        this.button.position(displayWidth/4 + 100, displayHeight-140);
        this.reset.position(displayWidth/4 + 300, displayHeight-140);

        this.question1.position(displayWidth/4-100, 300);
        this.radio.position(displayWidth/4 +150, 360);
        
        this.question2.position(displayWidth/4-100, 400);
        this.radio1.position(displayWidth/4 +150, 460);

        this.question3.position(displayWidth/4-100, 500);
        this.radio2.position(displayWidth/4 +150, 560);

        this.description.position(displayWidth/4 +30,710);
        ...
        this.button.mousePressed(() => {
            ...
            this.greeting.position(displayWidth/4-30,710);
